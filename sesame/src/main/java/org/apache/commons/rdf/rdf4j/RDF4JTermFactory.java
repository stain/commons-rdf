...
import org.openrdf.sesame.model.BNode;
import org.openrdf.sesame.model.Model;
import org.openrdf.sesame.model.Statement;
import org.openrdf.sesame.model.Value;
import org.openrdf.sesame.model.ValueFactory;
import org.openrdf.sesame.model.impl.LinkedHashModel;
import org.openrdf.sesame.model.impl.SimpleValueFactory;
...
public class RDF4JTermFactory implements RDFTermFactory {
	 ...
	 * {@link org.openrdf.sesame.model.BNode} is converted to a
	 * {@link org.apache.commons.rdf.api.BlankNode}, a
	 * {@link org.openrdf.sesame.model.IRI} is converted to a
	 * {@link org.apache.commons.rdf.api.IRI} and a
	 * {@link org.openrdf.sesame.model.Literal}. is converted to a
	...
	public static <T extends Value> RDF4JTerm<T> asRDFTerm(final T value, UUID salt) {
		...
		if (value instanceof org.openrdf.sesame.model.Literal) {
			return (RDF4JTerm<T>) new LiteralImpl((org.openrdf.sesame.model.Literal) value);
		}
		if (value instanceof org.openrdf.sesame.model.IRI) {
			return (RDF4JTerm<T>) new IRIImpl((org.openrdf.sesame.model.IRI) value);
		}
	...
	public Statement asStatement(TripleLike<BlankNodeOrIRI, org.apache.commons.rdf.api.IRI, RDFTerm> tripleLike) {
		...
		org.openrdf.sesame.model.Resource subject = (org.eclipse.rdf4j.model.Resource) asValue(tripleLike.getSubject());
		org.openrdf.sesame.model.IRI predicate = (org.eclipse.rdf4j.model.IRI) asValue(tripleLike.getPredicate());
		Value object = asValue(tripleLike.getObject());

		org.openrdf.sesame.model.Resource context = null;
		if (tripleLike instanceof Quad) {
			Quad quad = (Quad) tripleLike;
			context = (org.openrdf.sesame.model.Resource) asValue(quad.getGraphName().orElse(null));
		}
	 ...
	 * {@link org.openrdf.sesame.model.BNode}, a
	 * {@link org.apache.commons.rdf.api.IRI} is converted to a
	 * {@link org.openrdf.sesame.model.IRI} and a
	 * {@link org.apache.commons.rdf.api.Literal} is converted to a
	 * {@link org.openrdf.sesame.model.Literal}.
	 * <p>
	...
	public Value asValue(RDFTerm term) {
		...
		if (term instanceof org.apache.commons.rdf.api.Literal) {
			...
			org.openrdf.sesame.model.IRI dataType = (org.eclipse.rdf4j.model.IRI) asValue(literal.getDatatype());
	...
	public RDF4JLiteral createLiteral(String lexicalForm)
		...
		org.openrdf.sesame.model.Literal lit = getValueFactory().createLiteral(lexicalForm);
	...
	public org.apache.commons.rdf.api.Literal createLiteral(String lexicalForm, org.apache.commons.rdf.api.IRI dataType)
			throws IllegalArgumentException, UnsupportedOperationException {
		org.openrdf.sesame.model.IRI iri = getValueFactory().createIRI(dataType.getIRIString());
		org.openrdf.sesame.model.Literal lit = getValueFactory().createLiteral(lexicalForm, iri);
	...
	public org.apache.commons.rdf.api.Literal createLiteral(String lexicalForm, String languageTag)
			throws IllegalArgumentException, UnsupportedOperationException {
		org.openrdf.sesame.model.Literal lit = getValueFactory().createLiteral(lexicalForm, languageTag);
		return (org.apache.commons.rdf.api.Literal) asRDFTerm(lit);
	}
	...
	public RDF4JTriple createTriple(BlankNodeOrIRI subject, org.apache.commons.rdf.api.IRI predicate, RDFTerm object)
		...
		final Statement statement = getValueFactory().createStatement(
				(org.openrdf.sesame.model.Resource) asValue(subject),
				(org.openrdf.sesame.model.IRI) asValue(predicate), 
				asValue(object));
	...
	public Quad createQuad(BlankNodeOrIRI graphName, BlankNodeOrIRI subject, IRI predicate, RDFTerm object)
		...
		final Statement statement = getValueFactory().createStatement(
				...
				(org.openrdf.sesame.model.IRI) asValue(predicate), 
				asValue(object), 
				(org.openrdf.sesame.model.Resource)asValue(graphName));
